...
function checkForWebSocketServers(ws){
    ...
    testWsMarchat.on("open", function(event) {sendMessage(ws, "wsStatus:marchat true")});
    testWsMarchat.on('error', function(event) {sendMessage(ws, "wsStatus:marchat false")});
}